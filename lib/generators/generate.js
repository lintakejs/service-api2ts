...
class CodeGenerator {
    ...
    getIndex() {
      ...
      ${this.surrounding === config_1.Surrounding.typeScript ? '(window as any)' : 'window'}.defs = defs;
    `;
    ...
    getModsIndex() {
        let conclusion = `
      ${this.surrounding === config_1.Surrounding.typeScript ? '(window as any)' : 'window'}.API = {
